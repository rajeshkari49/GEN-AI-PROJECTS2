...
Original file is located at
    https://colab.research.google.com/drive/1YlkDTiBNlWrv6Q63A189h_-HsMaP3P9r
"""
...
minutes = {
    "Meeting Title": meeting_title, "Date": date, "Time": time, "Participants": ", ".join(participants_list), "Agenda": "; ".join(agenda_list),
    "Decisions Taken": "; ".join(decisions_list), "Action Items":"; ".join(actions_list), "Prepared By": prepared_by,
